  ...
  return (
    <footer className="bg-gray-800 text-white py-6 md:h-50">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between md:items-start mt-4">
          {/* 좌측: Where to find us와 소셜미디어 링크들 */}
          <div className="flex flex-row justify-center md:items-start space-x-4 md:space-x-16 mb-4 md:mb-0">
          ...
          {/* 우측 */}
          <div className="text-center text-gray-300 md:flex md:flex-row space-x-1 space-y-1 md:mt-18">
